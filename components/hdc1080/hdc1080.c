...
static esp_err_t hdc1080_write_configuration_register(uint8_t rst, uint8_t heat,
                                                      uint8_t mode,
                                                      uint8_t t_res,
                                                      uint8_t h_res)
{
    uint16_t configuration_reg = ((rst & 0x01) << 15) | ((heat & 0x01) << 13) |
                                 ((mode & 0x01) << 12) |
                                 ((t_res & 0x01) << 10) | ((h_res & 0x03) << 9);
